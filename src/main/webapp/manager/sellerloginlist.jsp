						...
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<tr
									...
									<c:forEach items="${list}" var="sl" varStatus="vs">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="10%">
												${SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(sl.time)}
											</td>
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="10%">
												<c:if test="${sl.status == 0}">退出</c:if>
												<c:if test="${sl.status == 1}">登录</c:if>
											</td>
										</tr>
									</c:forEach>
							</table>
